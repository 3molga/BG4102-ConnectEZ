...
void ui_main_screen_init(void)
{
    ...
    ui_leftpanel = lv_obj_create(ui_main_screen);
    lv_obj_set_width(ui_leftpanel, lv_pct(20));
    lv_obj_set_height(ui_leftpanel, lv_pct(90));
    lv_obj_set_align(ui_leftpanel, LV_ALIGN_BOTTOM_LEFT);
    lv_obj_set_y(ui_leftpanel, lv_pct(2));
    ...
    static const char *lp_btnm_map[] = {"A", "\n",
                                        ...
                                        "C", "\n"
                                        "D", "" };
    ui_leftpanel_btnmatrix = lv_btnmatrix_create(ui_leftpanel);
    ...
    //  Apply buttonmatrix styles (to do)
